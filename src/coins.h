...
// Copyright (c) 2018-2019 The WINC association
//
...
#ifndef SOLIDAR_COINS_H
#define SOLIDAR_COINS_H
 ...
 *               * 8358: compact amount representation for 60000000000 (600 FRC)
 ...
 *             * 86ef97d579: compact amount representation for 234925952 (2.35 FRC)
 *             * 00: special txout type pay-to-pubkey-hash
 *             * 61b01caab50f1b8e9c50a5057eb43c2d9563a4ee: address uint160
 *  - vout[16]: bbd123008c988f1a4a4de2161e0f50aac7f17e7f9555caa4
 *              * bbd123: compact amount representation for 110397 (0.001 FRC)
 *              * 00: special txout type pay-to-pubkey-hash
...
public:
    ...
    CCoins(const CTransaction &tx, int nHeightIn) : fCoinBase(tx.IsCoinBase()), vout(tx.vout), nHeight(nHeightIn), nVersion(tx.nVersion), refheight(tx.refheight) {
        ClearUnspendable();
    }
...
public:
    ...
    /** Amount of solidar coming in to a transaction
